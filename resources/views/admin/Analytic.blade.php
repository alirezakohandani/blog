...
@section('content')
  ...
  <div class="antialiased sans-serif bg-gray-200 w-lg min-h-screen ">
      ...
      <div class="max-w-lg mx-auto py-10">
        <div class="shadow p-6 rounded-lg bg-white">
          <div class="md:flex md:justify-between md:items-center">
            <div>
              <h2 class="text-xl text-gray-800 font-bold leading-tight">Report posts with and without photos</h2>
    ...
    <script>
      function app() {
        return {
          chartData: [{{ $value }}, {{ $sum - $value }}],
          labels: ['Without image', 'With image'],
